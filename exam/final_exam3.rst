EE240500 Embedded System Laboratory Final Exam
################################################
:Date:    2019-06-19 15:00
:Tags:    Exams
:Summary: The Final Exam (Backup)
:Status:  Draft
...
#. `XBee and MQTT <https://forms.gle/pKkYhZBtpowGLQkz5>`__
...
#. Please measure the distance of the ping when you waving your hand in front of the ping.
#. Please write an mbed code to measure the distance and 
   transmit the data to a PC with XBEE every 1 sec.
#. Please write a Python code to receive the data from XBEE channel.
